...
app.get("/scrape", function(req, res) {
    axios.get("https://www.powerball.com/winner-stories").then(function(response) {
...
app.post("/saved/:id", function(req, res) {
    // Using the id passed in the id parameter, prepare a query 
    // that finds the matching one in our db
    db.Article.findOne({ _id: req.params.id })
    // and populate all of the notes associated with it
    .populate("note")
    .then(function(dbArticle) {
        // If we were able to successfully find an Article 
        // with the given id, send it back to the client
        res.json(dbArticle);
    })
    .catch(function(err) {
        // If an error occurred, send it to the client
